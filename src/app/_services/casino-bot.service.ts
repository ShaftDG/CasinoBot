...
export class CasinoBotService {
  ...
  getCasinoBot(id: string): Observable<any> {
    const url = `${apiUrl}/${id}`;
  ...
  postCasinoBot(data): Observable<any> {
  ...
  updateCasinoBot(id: string, data): Observable<any> {
    const url = `${apiUrl}/${id}`;
  ...
  deleteCasinoBot(id: string): Observable<{}> {
    const url = `${apiUrl}/${id}`;
